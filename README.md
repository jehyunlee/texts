...
2. `Fast.ai` [estimating_an_optimal_learning_rate_for_a_deep_neural_network](https://github.com/jehyunlee/texts/blob/master/estimating_an_optimal_learning_rate_for_a_deep_neural_network/text.md)
